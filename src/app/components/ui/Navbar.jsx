    ...
    <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-xl bg-slate-950/70 border-b border-white/10 shadow-lg">
      <div className="max-w-7xl mx-auto h-20 px-6 flex items-center justify-between">
        ...
        <Button
          ...
          className="hidden lg:flex bg-slate-900 border border-cyan-500 text-cyan-400 hover:bg-cyan-500 hover:text-black transition-all duration-300 px-2 py-2 font-semibold rounded-xl"
        >
          Hire Me
        </Button>
